...
class QoSTopo(Topo):
    def build(self):
        ...
        # We remove bw=10 here so it doesn't fight with our OVS Queues below
...
def run():
    ...
    time.sleep(1) # Give the switch a second to wake up
    
    # Queue 0 (Slow Lane): Max 2 Mbps for UDP Junk
    # Queue 1 (VIP Lane): Min 8 Mbps for ICMP Pings
